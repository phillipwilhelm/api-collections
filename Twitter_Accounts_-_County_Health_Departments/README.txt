## Overview 
This is a Twitter collection for the county health departments for all 50 states in the US. Providing a collection that can be run manually using Postman runenrs, and on a schedule using Postman monitors. Pulling Tweets from across 300+ county health departments across 50 states. This collection is automatically generated from crowdsource data, which is also available as a Postman collection for use in other applications.
